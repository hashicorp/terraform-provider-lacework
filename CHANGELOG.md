...
* Unable to read inputs from provider  https://github.com/terraform-providers/terraform-provider-lacework/issues/6
* Avoid updating GCP resources on second `terraform apply` https://github.com/terraform-providers/terraform-provider-lacework/issues/4
